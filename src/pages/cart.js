        ...
        ${cart.map(item => `
          <tr>
            <td class="hidden pb-4 md:table-cell">
              <a href="#">
                <img class="mx-auto" src="${item.img}" width="100"/>
              </a>
            </td>
            <td>
              <p class="mb-2 md:ml-4">${item.title}</p>
              <form action="" method="POST">
                <button id="btn btn-remove" type="submit" class="text-gray-700 md:ml-4">
            ...
            <div class="w-20 h-10">
              ...
              <input class="w-24" type="number" value="${item.quantity}" />
            </div>
